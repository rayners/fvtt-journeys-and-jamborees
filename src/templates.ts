export const preloadTemplates = async function () {
  ...
  const partialPaths = [
    {
      name: 'pathfinder-selector',
      path: 'modules/journeys-and-jamborees/templates/partials/pathfinder-selector.hbs'
    },
    {
      name: 'party-sheet-inventory',
      path: 'modules/journeys-and-jamborees/templates/partials/party-sheet-inventory.hbs'
    },
    {
      name: 'party-sheet-journal',
      path: 'modules/journeys-and-jamborees/templates/partials/party-sheet-journal.hbs'
    },
    {
      name: 'party-sheet-members',
      path: 'modules/journeys-and-jamborees/templates/partials/party-sheet-members.hbs'
    },
    {
      name: 'party-sheet-settings',
      path: 'modules/journeys-and-jamborees/templates/partials/party-sheet-settings.hbs'
    },
    {
      name: 'party-sheet-travel',
      path: 'modules/journeys-and-jamborees/templates/partials/party-sheet-travel.hbs'
    }
  ];
